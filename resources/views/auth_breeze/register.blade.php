...
@section('content')
    <div class="space-y-6">
        <header class="space-y-1 text-center">
            ...
            <p class="text-sm text-zinc-500">{{ __('Join TaskInfinity to organize your missions and routines.') }}</p>
        </header>
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-5">
            ...
            <div class="space-y-2">
                <label for="name" class="block text-sm font-medium text-left">{{ __('Name') }}</label>
                <input
                    id="name"
                    type="text"
                    name="name"
