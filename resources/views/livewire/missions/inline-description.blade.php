...
@pushOnce('styles', 'inline-desc-styles')
    <style>
        :root {
            --inline-desc-bg: var(--bg, #111428);
            --inline-desc-fg: var(--fg, #d5daf1);
            --inline-desc-muted: var(--muted, rgba(148, 163, 184, 0.75));
            --inline-desc-border: var(--border, rgba(148, 163, 184, 0.3));
            --inline-desc-ring: rgba(122, 162, 255, 0.4);
            --inline-desc-shadow: rgba(15, 23, 42, 0.28);
            --inline-desc-menu-bg: color-mix(in srgb, var(--bg, #0f172a) 85%, #1f2a3f 15%);
        }
