...
<x-app-layout>
    <div class="app">
        ...
        <aside class="sidebar panel">
            ...
            <nav>
                <ul class="nav-list">
                    <li><a class="nav-item" href="#"><i class="icon" data-lucide="infinity"></i><span
                                class="label">All</span><span class="count">38</span></a></li>
                    <li><a class="nav-item" href="#"><i class="icon" data-lucide="sun"></i><span
                                class="label">Today</span></a></li>
                    <li><a class="nav-item" href="#"><i class="icon" data-lucide="calendar-days"></i><span
                                class="label">Next 7 Days</span></a></li>
                ...
                <ul class="nav-list">
                    <li>
                        <a class="nav-item" href="#">
                            <i class="icon" data-lucide="list-todo"></i>
                            <span class="label">Tasks</span>
                        </a>
                    </li>
                    <li>
                        <a class="nav-item" href="#">
                            <i class="icon" data-lucide="flame"></i>
            ...
            <h6>Tags</h6>
            <div class="tags">
                <a class="tag" href="#"><span class="dot" style="background:#f87171"></span>
                    <span>Bugs</span> <span class="count" style="margin-left:auto"> </span></a>
                <a class="tag" href="#"><span class="dot" style="background:#22d3ee"></span>
                    <span>Melhorias</span></a>
            </div>
                    ...
                    <div class="subgroup" aria-expanded="true">
                        ...
                        <div class="task-list">
                            ...
                            <div class="task has-subtasks" aria-expanded="true">
                                ...
                                <div class="expander" title="Expandir/ocultar subtarefas"><i
